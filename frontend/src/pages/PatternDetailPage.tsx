  ...
  return (
    <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
            <thead>
              <tr style={{ borderBottom: "1px solid var(--color-border)" }}>
                <th style={{ padding: "12px 16px", textAlign: "left", fontWeight: 500, color: "var(--color-text-muted)", fontSize: 13 }}>
                  前瞻窗口
                </th>
                <th style={{ padding: "12px 16px", textAlign: "right", fontWeight: 500, color: "var(--color-text-muted)", fontSize: 13 }}>
                  胜率
                </th>
                <th style={{ padding: "12px 16px", textAlign: "right", fontWeight: 500, color: "var(--color-text-muted)", fontSize: 13 }}>
                  平均收益
                ...
                return (
                  <tr key={key} style={{ borderBottom: "1px solid var(--color-border)" }}>
                    ...
                    <td style={{
                      ...
                      color: w.win_rate != null ? "var(--color-text)" : "var(--color-text-muted)", fontWeight: 500,
                    }}>
                      {fmtWinRate(w.win_rate)}
                    </td>
                    <td style={{
                      padding: "12px 16px", textAlign: "right", fontVariantNumeric: "tabular-nums",
                      color: w.avg_return != null ? (w.avg_return >= 0 ? "var(--color-bullish)" : "var(--color-bearish)") : "var(--color-text-muted)",
                    }}>
                      {fmtPct(w.avg_return)}
                    </td>
      ...
      <section>
        <h2 style={{ fontSize: 16, fontWeight: 600, color: "var(--color-text)", margin: "0 0 var(--space-3) 0" }}>
          最新触发该形态的股票
          <span style={{ fontSize: 13, fontWeight: 400, color: "var(--color-text-muted)", marginLeft: "var(--space-2)" }}>
            ({stocks.length} 只)
          </span>
        </h2>
        {stocks.length === 0 ? (
